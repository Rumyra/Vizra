...
class Canvas {
	 ...
	 * make element be anything
	 * make size just be pixels
	 ...
	 * @example
	 * let opts = {
	 *   element: 'canvas' // string, dom, undefined
	 *   width: CSS.px(300) // css val type, undefined
	 *   height: CSS.px(300) // css val type, undefined
	 * }
	 * const myCanvas = new Canvas(opts) where opts = {element: 'canvas}
	 */
