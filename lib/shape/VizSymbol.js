...
class VizSymbol {
	...
	set position(pos) {
		this._position = this._setMesurement(pos);
	...
	set size(size) {
		this._size = this._setMesurement(size);
	 ...
	 * setMesurement
	 * @private
	 * @description private function to set a vector if mesurement (pos, size, scale, offset) have been set directly
